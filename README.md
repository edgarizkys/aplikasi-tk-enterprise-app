# Aplikasi Tk Enterprise

ðx« Sistem Manajemen Tk Enterprise - World-Class Enterprise v5.0
...
## Entities
- **Siswa/Peserta**: NIS/ID, Nama Lengkap, Kelas, Jurusan/Mata Pelajaran, Tahun Masuk, Status
- **Guru/Pengajar**: NIP/ID, Nama Lengkap, Mata Pelajaran, Jabatan, Status
- **Pembayaran**: Nama Peserta, Keterangan, Nominal (Rp), Metode Pembayaran, Status
